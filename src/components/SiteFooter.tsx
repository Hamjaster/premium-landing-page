...
export default function SiteFooter() {
  return (
    <footer aria-label="Site Footer" className="relative z-30 overflow-hidden border-t border-white/[0.06] bg-[#04100d]">
      <div
      ...
      <div className="relative z-10 mx-auto w-[min(1380px,calc(100%-64px))] py-[clamp(40px,5vw,72px)] max-[1100px]:w-[calc(100%-36px)]">
        <div className="grid gap-10 lg:grid-cols-[1.2fr_0.8fr]">
          <FadeIn direction="up" className="max-w-[34rem]">
        ...
        <div className="mt-12 flex flex-col gap-4 border-t border-white/[0.06] pt-5 text-[0.78rem] font-light tracking-[0.08em] text-white/32 sm:flex-row sm:items-center sm:justify-between">
