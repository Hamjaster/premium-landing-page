...
const approachCards = [
  {
    ...
    bgGradient: 'from-[#2A0F0F] via-[#1A0A0A] to-[#0D0505]',
  },
  {
...
export default function ApproachSection() {
  ...
  return (
    <section
      ...
      className="relative z-30 overflow-hidden bg-[#1A0A0A]"
    >
      {/* Background layers */}
      ...
      <div
        ...
        style={{
          background:
            'radial-gradient(ellipse 70% 50% at 50% 30%, rgba(230, 57, 70, 0.2) 0%, transparent 70%)',
          filter: 'blur(80px)',
        }}
      />
      <div
        ...
        style={{
          background:
            'radial-gradient(ellipse 50% 40% at 60% 70%, rgba(255, 107, 53, 0.15) 0%, transparent 70%)',
          filter: 'blur(60px)',
        }}
      />
      ...
      <div className="relative z-10 mx-auto w-[min(1380px,calc(100%-64px))] py-[clamp(80px,10vw,140px)] max-[1100px]:w-[calc(100%-36px)]">
        ...
        <FadeIn direction="up" className="mb-[clamp(48px,6vw,80px)] text-center">
          ...
          <div className="mx-auto mt-6 h-px w-16 bg-gradient-to-r from-transparent via-[#E63946]/40 to-transparent" />
        </FadeIn>
        ...
        <div className="grid grid-cols-2 gap-6 max-[768px]:grid-cols-1 max-[768px]:gap-4">
          {approachCards.map((card, i) => (
            <div
              ...
              className="group relative overflow-hidden rounded-[20px] border border-white/[0.06] bg-[#2A0F0F]/60 backdrop-blur-sm transition-all duration-500 hover:border-white/[0.12]"
            >
              ...
              <div
                ...
                style={{
                  background:
                    'radial-gradient(circle at 30% 30%, rgba(230, 57, 70, 0.08) 0%, transparent 60%)',
                }}
              />
              ...
              <div className="relative flex min-h-[220px] flex-col justify-between p-[clamp(24px,3vw,40px)] max-[768px]:min-h-[180px]">
                {/* Icon + Title */}
                <div>
                  <div className="mb-4 flex h-11 w-11 items-center justify-center rounded-full border border-[#E63946]/20 bg-[#E63946]/8 text-[#E63946] transition-colors duration-300 group-hover:border-[#E63946]/35 group-hover:bg-[#E63946]/15">
                    {card.icon}
                  </div>
