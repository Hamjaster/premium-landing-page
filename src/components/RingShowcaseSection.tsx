import ringImage from '../assets/shoes.png';
...
const highlights = [
  ...
  'Red and orange accents remain restrained so the shoe still leads.',
];

export default function RingShowcaseSection() {
  return (
    <section aria-label="Signature Piece" className="relative z-30 overflow-hidden bg-[#1A0A0A]">
      <div
        className="absolute inset-0 opacity-30"
        style={{
          background:
            'radial-gradient(ellipse 60% 45% at 25% 30%, rgba(230, 57, 70, 0.24) 0%, transparent 68%)',
          filter: 'blur(100px)',
        }}
      />
      <div
        ...
        style={{
          background:
            'radial-gradient(ellipse 60% 50% at 78% 68%, rgba(255, 107, 53, 0.72) 0%, transparent 70%)',
          filter: 'blur(90px)',
        }}
      />
...
Rooted in deep spikes, we deliver world-class shoes            </p>

            <div className="mt-8 h-px w-20 bg-gradient-to-r from-transparent via-[#E63946]/40 to-transparent" />
            ...
            <div className="mt-8 space-y-4">
              {highlights.map((highlight, index) => (
                <div key={highlight} className="flex items-start gap-4 rounded-[18px] border border-white/[0.06] bg-white/[0.025] px-4 py-4 backdrop-blur-sm">
                  <div className="mt-1 h-2.5 w-2.5 shrink-0 rounded-full bg-[#E63946]" />
            ...
            <div className="mt-10 flex flex-wrap items-center gap-3">
              ...
              <button
                type="button"
                className="rounded-full border border-[#E63946]/25 bg-[#E63946]/10 px-6 py-3 text-[0.92rem] font-medium text-[#FF8F8F] transition-colors duration-200 hover:border-[#E63946]/40 hover:bg-[#E63946]/14"
              >
        ...
        <FadeIn direction="up" delay={0.08} className="relative">
          <div className="relative min-h-[680px] overflow-hidden rounded-[34px] border border-white/[0.08] bg-[linear-gradient(180deg,rgba(255,255,255,0.04),rgba(255,255,255,0.015))] p-5 shadow-[0_24px_80px_rgba(0,0,0,0.35)] backdrop-blur-sm max-[768px]:min-h-[520px]">
            <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_22%,rgba(230,82,43,0.18)_0%,transparent_48%)]" />
            ...
            <div className="relative z-10 flex h-full flex-col justify-between">
              ...
              <div className="relative flex flex-1 items-center justify-center py-8">
                <div className="absolute inset-12 rounded-full bg-[#E63946]/[0.06] blur-3xl" />
                <img
                  src={ringImage}
                  alt="Ring inspired signature form"
                  className="relative z-10 w-full max-w-[520px] object-contain drop-shadow-[0_24px_36px_rgba(0,0,0,0.5)]"
                />
              </div>
